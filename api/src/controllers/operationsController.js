const {employmentOperationSchema} = require('../validators/operationsValidator');
...
exports.updateOperations = async (req, res) => {
    try {
        ...
        const result = await pool.query(
            ...
            [employee_registry_id, operation_type_id, position_id, department_id, salary_change, operation_date, id]
        );
